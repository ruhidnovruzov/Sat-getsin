...
const Sign_In = () => {
  ...
  const handleSignIn = () => {
    if (email === "ruhidnovruzov4@gmail.com" && password === "1234") {
      window.location.href = "/profile";
    } else {
      alert("Daxil etdiyiniz məlumatlar düzgün deyil.");
    }
  };

  return (
    <div className="w-full flex items-center justify-center py-32 bg-[#F6F8FE]">
      <div className="w-[28%] max-sm:w-[90%]">
          ...
          <div>
            <div className="mt-10">
              ...
              <input
                ...
                className="mt-3 h-12 pl-5 bg-[#EFF3FA] w-[80%] max-sm:w-full rounded-[5px]"
              />
            </div>
            <div className="mt-10">
            ...
            <div className="mt-7">
              ...
              <div className="relative">
                ...
                />
                <button
                  className="text-[#d0cfd6] absolute mt-6  right-24 max-sm:right-4"
            ...
            <div className="flex mt-2 items-center gap-2">
              ...
              <label className="text-[#ABA9B7] font-bold text-sm">
                <span className="font-bold text-[#6A5BCD]">
                  İstifadəçi şərtləri{" "}
                </span>
                ilə razıyam
              </label>
            ...
            <div className="mt-10">
              <button className="w-[80%] max-sm:w-full h-16 font-bold rounded-[5px] bg-[#E9E8EE] text-white transition-all duration-300 hover:bg-[#6A5BCD]">
                Qeydiyyatdan keçin
              </button>
            </div>
            <p className="my-5 text-center w-[80%] max-sm:w-full">
              Hesabınız var? o zaman
            </p>
            <div>
              <Link href="/profile">
                <button className="w-[80%] max-sm:w-full h-16 border-2 rounded-[5px] text-[#6A5BCD] border-[#6A5BCD] font-bold transition-all duration-300 hover:bg-[#E9E8EE]">
                  Daxil ol
                </button>
              </Link>
            </div>
        ...
        {emailPageVisible && (
          <div>
            ...
            <div className="flex justify-between w-[80%] max-sm:w-full mt-5">
            ...
            <div className="mt-10">
              <button
                ...
                className="w-[80%] max-sm:w-full h-16 font-bold rounded-[5px] bg-[#E9E8EE] text-white transition-all duration-300 hover:bg-[#6A5BCD]"
              >
                Daxil ol
              </button>
            </div>
            <p className="my-5 text-center w-[80%] max-sm:w-full">
              Saytımızda yenisiz? o zaman
            </p>
            <div>
              <button
                className="w-[80%] max-sm:w-full h-16 border-2 rounded-[5px] text-[#6A5BCD] border-[#6A5BCD] font-bold transition-all duration-300 hover:bg-[#E9E8EE]"
